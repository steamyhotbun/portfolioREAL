          ...
          {project.id === 'corsace-closed-2024-1' && (
            <>
              ...
              <div style={{ display: 'flex', flexDirection: 'row', gap: 24, justifyContent: 'center', margin: '32px 0' }}>
                <img src={pi_1} alt="Corsace Manga 1" style={{ maxWidth: 240, width: '100%', borderRadius: 16 }} loading="lazy" />
                <img src={pi_2} alt="Corsace Manga 2" style={{ maxWidth: 240, width: '100%', borderRadius: 16 }} loading="lazy" />
              </div>
            </>
          )}
